...
while place_order:
    ...
    if menu_category.isdigit():  # Checks if the input is a digit
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection= input("Which menu item would you like to have? ")
...
spaces = 25 - len(item_name)

space_str = " " * spaces

print(f"{item_name}{space_str}| ${price:.2f}  | {quantity}")
